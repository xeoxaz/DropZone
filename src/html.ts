        ...
        class TriFlowIngest {
            ...
            renderGridView(files) {
                ...
                container.innerHTML = files.map(file => {
                    ...
                    const escapedMode = JSON.stringify(file.mode);
                    ...
                    return '<div class="file-item-grid" onclick="triFlow.previewFile(' + escapedPath + ', ' + escapedMode + ', ' + escapedName + ')">' +
                        fileIcon +
                        '<div class="file-name-grid">' + file.name + '</div>' +
                        '<div class="file-actions">' +
                            '<button class="action-btn" onclick="event.stopPropagation(); triFlow.downloadFile(' + escapedPath + ', ' + escapedMode + ', ' + escapedName + ')">Download</button>' +
                            '<button class="action-btn delete" onclick="event.stopPropagation(); triFlow.deleteFile(' + escapedPath + ', ' + escapedMode + ', ' + escapedName + ')">Delete</button>' +
                        '</div>' +
                    '</div>';
                }).join('');
            }
            ...
            renderListView(files) {
                ...
                container.innerHTML = files.map(file => {
                    ...
                    return '<div class="file-item-list" onclick="triFlow.previewFile(' + escapedPath + ', ' + escapedMode + ', ' + escapedName + ')">' +
